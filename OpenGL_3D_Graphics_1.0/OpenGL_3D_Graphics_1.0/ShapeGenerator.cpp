...
//	Vertex StackVerts[] = {
//		// Front face
//		glm::vec3(-1.0f,  1.0f, -1.0f), glm::vec3(1.0f, 0.0f, 0.0f), // 0: Top-left
//		glm::vec3(1.0f,  1.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f), // 1: Top-right
//		glm::vec3(-1.0f, -1.0f, -1.0f), glm::vec3(1.0f, 0.0f, 1.0f), // 2: Bottom-left
//		glm::vec3(1.0f, -1.0f, -1.0f), glm::vec3(1.0f, 0.0f, 0.0f), // 3: Bottom-right
//
//		// Back face
//		glm::vec3(-1.0f,  1.0f,  1.0f), glm::vec3(1.0f, 0.0f, 0.0f), // 4: Top-left
//		glm::vec3(1.0f,  1.0f,  1.0f), glm::vec3(0.0f, 1.0f, 0.0f), // 5: Top-right
//		glm::vec3(-1.0f, -1.0f,  1.0f), glm::vec3(1.0f, 0.0f, 1.0f), // 6: Bottom-left
//		glm::vec3(1.0f, -1.0f,  1.0f), glm::vec3(1.0f, 0.0f, 0.0f), // 7: Bottom-right
//	};
//
//	res.numVertices = sizeof(StackVerts) / sizeof(*StackVerts);
//	res.vertices = new Vertex[res.numVertices];
